...
public class Constants {
    public static final String KEY_EXCEPTION_PHONE_NUMBER_TAKEN = "Phone number already taken";
    public static final String KEY_EXCEPTION_CANT_SAVE_USER = "Can't save user";
    public static final String KEY_EXCEPTION_USER_NOT_FOUND = "User not found";
    public static final String KEY_EXCEPTION_BAD_CREDENTIALS = "Bad credentials";
    public static final String KEY_EXCEPTION_INVALID_TOKEN = "Invalid token";
